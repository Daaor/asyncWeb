...
function renderUsers(usersList){ // Handles creating of individual cards from the elements in the array passed as an argument
  ...
  usersList.forEach((user) => {
    ...
    userCard.innerHTML = `
      ...
      <button class="deleteBtn px-4 mt-5 rounded-full pt-5 bg-red-300 border-none text-white hover:bg-red-600 hover:shadow-lg hover:-translate-y-1 transition-all duration-500 ease-in-out">Delete user</button>
    `;
